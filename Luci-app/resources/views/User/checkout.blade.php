  ...
  <div class="flex p-4 mx-28 gap-4">
    ...
    <div class="w-1/2 p-5">
      ...
      <div class="flex justify-between mb-2">
        ...
        <div>
          <button class="text-blue-600 hover:underline flex items-center gap-2 py-2 text-left focus:outline-none">
      ...
      <div class="flex gap-3 p-3 bg-gray-50 rounded-md">
        ...
        <div>
          <p class="font-medium">Delivery : $1.25</p>
          <p class="text-gray-600 text-sm">Luci Fashion(Delivery withing 1-3days)</p>
        </div>
      </div>
      <div class="py-4">
        <h1 class="font-medium text-lg mb-2">My shopping bag (2)</h1>
    ...
    <div class="w-1/2  p-5">
      ...
      <div class="mb-4">
        ...
        <textarea id="note" name="note" rows="4" cols="50" class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none"></textarea>
      </div>
