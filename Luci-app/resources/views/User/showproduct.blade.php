<x-layout>
    <div class="flex flex-col md:flex-row py-8 px-4 md:py-16 md:px-8 lg:mx-16 xl:mx-32 gap-8 md:gap-16">
        ...
        <div class="flex gap-4 md:gap-8">
            ...
            <img src="{{ asset($product['image_path']) }}" alt="Main Product"
        ...
        <div class="w-full md:w-1/2 space-y-6">
            ...
            <div class="border-b border-gray-200 pb-4">
                <h3 class="text-2xl font-bold text-gray-800">US ${{ $product['price'] }}</h3>
        ...
        <div class="flex items-center">
          ...
          Add to Bag
                ...
                <button
                    class="p-3 bg-gray-100 hover:bg-gray-200 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600 hover:text-red-500"
            ...
            <div class="mt-8 pt-4 border-t border-gray-200">
                <button class="w-full flex items-center justify-between py-2 text-left focus:outline-none group">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="h-5 w-5 text-gray-500 group-hover:text-blue-500 transform transition-transform group-hover:rotate-180"
    ...
    {{-- Related Products --}}
    <h1 class="text-3xl font-bold px-4 md:px-8 lg:mx-16 xl:mx-32 gap-8 md:gap-16">Related Products</h1>
    <div class="flex flex-col md:flex-row py-8 px-4 md:py-16 md:px-8 lg:mx-16 xl:mx-32 gap-8 md:gap-16">
