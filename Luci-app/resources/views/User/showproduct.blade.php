<x-layout>
  <div class="flex flex-col md:flex-row py-8 px-4 md:py-16 md:px-8 lg:mx-16 xl:mx-32 gap-8 md:gap-16">
    ...
    <div class="flex gap-4 md:gap-8">
      ...
      <img src="{{ asset($product['src']) }}" alt="Main Product" class="w-64 md:w-80 lg:w-96 object-cover rounded-lg shadow-sm">
    </div>
    ...
    <div class="w-full md:w-1/2 space-y-6">
      ...
      <div class="border-b border-gray-200 pb-4">
        ...
        <p class="text-lg text-gray-700 mt-2">{{ $product['info'] }}</p>
      </div>
      ...
      <div class="space-y-3">
        ...
        <div class="flex items-center">
          <button class="w-10 h-10 flex items-center justify-center rounded-l-lg bg-gray-100 hover:bg-gray-200 border border-gray-300 text-xl font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">-</button>
          <div class="w-12 h-10 flex items-center justify-center border-t border-b border-gray-300 bg-white text-gray-800">1</div>
          <button class="w-10 h-10 flex items-center justify-center rounded-r-lg bg-gray-100 hover:bg-gray-200 border border-gray-300 text-xl font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">+</button>
        </div>
      </div>
      
      {{-- Add to bag --}}
      <div class="flex gap-3 pt-3">
        <button class="flex-1 bg-black hover:bg-gray-800 text-white py-3 px-6 rounded-lg font-medium transition shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
          Add to Bag
        </button>
      ...
      <div class="mt-8 pt-4 border-t border-gray-200">
        ...
        <div class=" mt-3 text-gray-600">
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean auctor pretium sem, sed aliquet neque porttitor id. In lacinia metus non cursus placerat. Duis ac neque vulputate, consectetur nulla nec, faucibus urna. Proin in malesuada enim. Nunc varius ipsum molestie sapien imperdiet, eget faucibus eros interdum. Nullam facilisis</p>
        </div>
      </div>
    </div>
  </div>
